// Diálogos de la Parte 8 - La confesión (dragón + meta mínimo)
const dialogues = [
    {
        character: "Tú",
        text: "Espera.",
    ...
    {
        character: "Tú",
        text: "El autor se quedó sin finales épicos.",
        video: "../shared/him-knight-talking.mp4"
    },
    {
        character: "Ella",
    ...
    {
        character: "Tú",
        text: "Así que solo puedo decir esto…",
        video: "../shared/him-knight-talking.mp4"
    },
    {
        type: "narration",
    ...
    {
        character: "Tú",
        text: "Te amo. ¿Pasamos San Valentín juntos?",
        video: "../shared/him-knight-talking.mp4"
    },
    {
        character: "Ella",
...
const chapterConfig = {
    ...
    endAnimation: "../shared/dragon-defeated.png",
    endAnimationType: "image",
    nextChapter: "../part9/index.html"
};
